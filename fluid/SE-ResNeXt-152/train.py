...
def parse_args():
    ...
    parser.add_argument(
        '--batch_size', type=int, default=12, help='the total batch size')
    parser.add_argument(
        '--batch_size_per_gpu',
        type=int,
        default=12,
        help='the batch size for every card')
    parser.add_argument(
        '--number_iteration',
        type=int,
        default=150,
    ...
    parser.add_argument(
        ...
        type=distutils.util.strtobool,
        default=True,
        help='If fix_data_in_gpu is True, the data will stat.')
    parser.add_argument(
...
def train_parallel_do(args):
    ...
    for batch_id in range(args.number_iteration):
        ...
        if (batch_id + 1) % args.display_step == 0:
            ...
            print("iter=%d, cost=%s, elapse=%f, img/s=%f" %
    ...
    print("average time:{0}, img/s:{1}".format(
